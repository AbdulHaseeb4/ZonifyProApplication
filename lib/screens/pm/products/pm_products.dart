...
class _PMProductsPageState extends State<PMProductsPage> {
  ...
  final List<String> typeOptions = [
    ...
    'Feedback', 'Rating', 'RAS', 'RAO', 'Seller Testing',
    'Pic Review', 'Vid Review',
  ];
    ...
    child: Center(
      child: Text(
        ...
        style: TextStyle(
          ...
          color: Colors.black87, // ✅ header dark
        ),
      ),
    ),
  );

  DataCell _c(int i, Widget child) =>
      DataCell(SizedBox(width: _colW[i], child: Center(child: child)));
  ...
  Widget _highlightText(String text, {bool isMobile = false}) {
    ...
    return RichText(
      text: TextSpan(
          style: TextStyle(fontSize: isMobile ? 11 : 12), children: spans),
    );
  }
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          prefixIcon:
          const Icon(Icons.search, color: AppTheme.lavender, size: 18),
      ...
      rows: filteredProducts.asMap().entries.map((entry) {
        ...
        return DataRow(
          ...
          cells: [
            ...
            _c(1, Text(p['market'], style: TextStyle(fontSize: isMobile ? 11 : 12))),
            _c(2, Text(p['saleLimit'], style: TextStyle(fontSize: isMobile ? 11 : 12))),
            _c(3, Text(p['todayRemain'], style: TextStyle(fontSize: isMobile ? 11 : 12))),
            _c(4, Text(p['totalRemain'], style: TextStyle(fontSize: isMobile ? 11 : 12))),
            _c(5, Text('PKR ${p['commission']}', style: TextStyle(fontSize: isMobile ? 11 : 12))),
            _c(6, _highlightText(p['keywords'], isMobile: isMobile)),
            _c(7, Tooltip(message: p['link'], child: Text(p['link'], overflow: TextOverflow.ellipsis))),
            _c(8, _highlightText(p['productId'], isMobile: isMobile)),
            _c(9, Image.asset("assets/images/sample.jpeg", width: 36, height: 36)),
            _c(
              10,
              Wrap(
                spacing: 6,
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: alreadyReserved ? Colors.grey : AppTheme.peach,
                      minimumSize: const Size(60, 28),
                    ),
                    child: Text(alreadyReserved ? "Reserved" : "Reserve",
